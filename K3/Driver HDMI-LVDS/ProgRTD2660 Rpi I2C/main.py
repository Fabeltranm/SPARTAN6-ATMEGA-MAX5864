...
print "Opening bus..."
bus = SMBus(1) # choose your bus 7 for usb tiny i2c
...
FlashDevices = [
    ...
    FlashDesc("W25Q80DV"   , 0xEF4014, 1 * 1024,       256, 64),
...
#jedec_id PCB800661 = 15679508
#jedec_id PCB800099 = 15675411
if jedec_id == 15679508:
    print "flash matches!"
else:
